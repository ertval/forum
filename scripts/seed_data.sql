...
-- Insert some test comments (INTEGER post_id and author_id)
INSERT OR IGNORE INTO comments (post_id, author_id, content, created_at, updated_at) VALUES
('post-1', 2, 'Great to be here!', datetime('now', '-6 days'), datetime('now', '-6 days')),        -- bob comments on post 1
('post-1', 3, 'Looking forward to interesting discussions.', datetime('now', '-6 days'), datetime('now', '-6 days')), -- charlie comments on post 1
('post-2', 1, 'I agree, Go is fantastic!', datetime('now', '-4 days'), datetime('now', '-4 days')), -- alice comments on post 2
('post-2', 3, 'Python is still my favorite though.', datetime('now', '-4 days'), datetime('now', '-4 days')), -- charlie comments on post 2
('post-3', 1, 'BOTW is amazing! Have you tried Tears of the Kingdom?', datetime('now', '-2 days'), datetime('now', '-2 days')); -- alice comments on post 3
