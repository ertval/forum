...
- When i run the up through docker run -p 8080:8080 i cant access the forum and get a connection reset error. Make sure we can run the app through docker run properly, and not only using compose and document the changes by udating the docs.