...
document.addEventListener('DOMContentLoaded', function() {
    ...
    // Get initial data from data attributes on the button or other element
    let offset = parseInt(loadMoreBtn.getAttribute('data-offset')) || 0; // Start after the already displayed posts
    const category = loadMoreBtn.getAttribute('data-category') || '';
    const myPosts = loadMoreBtn.getAttribute('data-my-posts') === 'true';
    const likedPosts = loadMoreBtn.getAttribute('data-liked-posts') === 'true';
